...
def gen_triangles():
    for i in range(150):
        ...
        elf_draw_parent(ELF_TEST_PARENT_ID, ["cube", position, scale, rotation])
        elf_end_color()
...
def elf_material_set_diffuse_id(id, rgba):
...
def draw_triangles():
    ...
    ELF_TEST_PARENT_ID = elf_draw(["cube", (0, 0, 0), (0.5, 0.5, 0.5), (0, 0, 0)], receive_shadows=False)
    elf_end_color()
    gen_triangles()
